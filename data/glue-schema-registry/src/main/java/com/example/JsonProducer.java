...
public class JsonProducer {
    ...
    private static final String SCHEMA_NAME = "sensor-schema";
    private static final String AWS_REGION = "us-east-1";

    public static void main(String[] args) {
        if (args.length < 1) {
            System.err.println("Usage: JsonProducer <properties-file> [bootstrap-servers-override]");
        ...
        // Create producer
        KafkaProducer<String, SensorReading> producer = new KafkaProducer<>(props);
        ...
        try {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                SensorReading sensorReading = new SensorReading(
                    "sensor-" + i,
                    20.0 + (i * 0.5),  // Temperature: 20.5, 21.0, 21.5, etc.
                    40.0 + (i * 0.5),  // Humidity: 40.5, 41.0, 41.5, etc.
                    System.currentTimeMillis()
                );

                // Create producer record
                ProducerRecord<String, SensorReading> record = new ProducerRecord<>(
                    TOPIC_NAME,
                ...
                logger.info("Sent sensor reading: sensorId={}, temperature={}, humidity={}, timestamp={}", 
                           sensorReading.getSensorId(), 
